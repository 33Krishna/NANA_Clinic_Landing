      ...
      <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
        ...
        <div className="text-center mb-8 reveal" style={{ transitionDelay: "200ms" }}>
          <img
            ...
            className="max-w-xs mx-auto rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
          />
        </div>
        
        <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
          <a href="#" className="flex justify-center items-center hover:scale-105 transition-transform duration-300">
            <img src={Signia} alt="Signia Logo" className="max-h-16 object-contain" />                        
          </a>
          <a href="#" className="flex justify-center items-center hover:scale-105 transition-transform duration-300">
            <img src={Oticon} alt="Oticon Logo" className="max-h-16 object-contain" />                                             
          </a>
          <a href="#" className="flex justify-center items-center hover:scale-105 transition-transform duration-300">
            <img src={Phonak} alt="Phonak Logo" className="max-h-16 object-contain" />                                                                 
          </a>
          <a href="#" className="flex justify-center items-center hover:scale-105 transition-transform duration-300">
            <img src={ReSound} alt="ReSound Logo" className="max-h-16 object-contain" />                                                                                   
          </a>
          <a href="#" className="flex justify-center items-center hover:scale-105 transition-transform duration-300">
            <img src={Unitron} alt="Unitron Logo" className="max-h-16 object-contain" />                                                                                  
          </a>
          <a href="#" className="flex justify-center items-center hover:scale-105 transition-transform duration-300">
            <img src={Widex} alt="Widex Logo" className="max-h-16 object-contain" />                                                                                    
          </a>
        </div>
      </div>
    </section>
